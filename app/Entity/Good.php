 ...
 * @method static \Illuminate\Database\Query\Builder|\App\Entity\Good whereStatus($value)
 * @property int $times
 * @method static \Illuminate\Database\Query\Builder|\App\Entity\Good whereTimes($value)
 */
