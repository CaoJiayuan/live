...
$(document).ready(function () {
  ...
  if (room != null) {
    var objectPlayer = new aodianPlayer({
      ...
      rtmpUrl          : 'rtmp://' + room.lss_user_id + '.lssplay.aodianyun.com/' + room.app_id + '/' + room.stream,//控制台开通的APP rtmp地址，必要参数
      hlsUrl           : 'http://' + room.lss_user_id + '.hlsplay.aodianyun.com/' + room.app_id + '/' + room.stream + '.m3u8',//控制台开通的APP hls地址，必要参数
      /* 以下为可选参数*/
